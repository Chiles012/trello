...
const Register = () => {
    return ( 
        <form class="form-horizontal" style={{ padding: '15px' }}>
            ...
            <button class="btn btn-primary btn-lg btn-block" style={{ margin: '15px 0', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}><i class="fab fa-facebook-f"></i>Register With Facebook</button>
